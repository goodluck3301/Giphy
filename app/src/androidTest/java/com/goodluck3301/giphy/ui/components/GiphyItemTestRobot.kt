...
import com.goodluck3301.giphy.ui.utils.downloadImageUsingMediaStore
...
internal class GiphyItemTestRobot(
    ...
    fun checkOpenInBrowserButton(url: String) {
        try {
            mockkStatic("com.goodluck3301.giphy.ui.utils.KotlinExtensionsKt")
            ...
            unmockkStatic("com.goodluck3301.giphy.ui.utils.KotlinExtensionsKt")
        } catch (e: AssertionError) {
            composeTestRule.onRoot().printToLog("GiphyItemTestRobotError")
